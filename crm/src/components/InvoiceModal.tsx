...
export default function InvoiceModal({ children, setIsOpen, isOpen }: Props) {
  function closeModal() {
    setIsOpen(false);
  }
    ...
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative z-90" onClose={closeModal}>
        ...
        <div className="fixed inset-0 overflow-y-auto p-4 lg:p-8">
          ...
          >
            <Dialog.Panel className="flex flex-col rounded shadow-sm bg-white overflow-hidden w-1/2 mx-auto">
              ...
              <div className="p-5 lg:p-6 grow w-full">{children}</div>
