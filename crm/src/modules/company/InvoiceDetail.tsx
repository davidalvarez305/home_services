...
export default function InvoiceDetail({ invoice }: Props) {
  ...
  const INVOICE_DIV = `${invoice.invoice_id}-invoice`;

  function handlePrintInvoice() {
    var printDiv = document.getElementById(INVOICE_DIV);
  ...
  return (
    <div
      id={INVOICE_DIV}
      className="flex flex-col rounded shadow-sm bg-white overflow-hidden xl:max-w-4xl mx-auto print:shadow-none"
    >
