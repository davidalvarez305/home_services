...
func (lq *LeadQuotes) GetQuotesByLead(leadId string) error {
	sql := `
	SELECT q.id, a.street_address_line1, a.street_address_line2, a.street_address_line3, ser.service, ser.id AS service_id,
	...
	c.city, c.id, s.id, s.state, q.id, q.zip_code, q.created_at, ctry.country, ctry.id;
	`
