...
func (lq *LeadQuotes) GetQuotesByLead(leadId string) error {
	sql := `
	SELECT q.id, a.street_address_line1, a.street_address_line2, a.street_address_line3,
	c.city, c.id AS city_id, s.state, s.id AS state_id, q.zip_code, q.created_at,
	...
	c.city, c.id, s.id, s.state, q.id, q.zip_code, q.created_at;
	`
